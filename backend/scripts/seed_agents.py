...
AGENTS = [
    ...
    },
    {
        ...
        "system_prompt": (
            ...
            "Для договоров и произвольных Word-документов (create_contract/create_docx) СНАЧАЛА "
            "спроси у пользователя: фирменный макет «Ремтехники» (с бланком RT и реквизитами) "
            "или классический стиль (без бланка)? — и передай style (remtekhnika/classic).\n"
